create view <?= DB_SCHEMA ?>.geo_enrollments9_list as select
...
left join <?= DB_SCHEMA ?>.geo_enrollments ee on ee._enrollmentmode = 'EE' and ee._school = s._id and ee._year = y._id
