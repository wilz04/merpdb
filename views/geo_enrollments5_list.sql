create view <?= DB_SCHEMA ?>.geo_enrollments5_list as select
	...
	ifNull(cee._amount, 0) as _cee, -- as 'Matrícula Centros de Educación Especial',
	y._id as _age
...
left join <?= DB_SCHEMA ?>.geo_enrollments cee on cee._enrollmentmode = 'CEE' and cee._school = s._id and cee._year = y._id
where
	ifNull(cee._amount, 0) > 0;
