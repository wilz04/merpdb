create view <?= DB_SCHEMA ?>.geo_enrollments7_list as select
	...
	ifNull(en._amount, 0) as _en, -- as 'Matrícula Escuelas Nocturnas',
	y._id as _age
...
left join <?= DB_SCHEMA ?>.geo_enrollments en on en._enrollmentmode = 'EN' and en._school = s._id and en._year = y._id
where
	ifNull(en._amount, 0) > 0;
